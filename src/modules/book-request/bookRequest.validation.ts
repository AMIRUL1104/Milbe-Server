...
export type CreateBookRequestInput = z.infer<typeof createBookRequestSchema>["body"];
export type BookRequestParamsInput = z.infer<typeof bookRequestParamsSchema>["params"];
export type CheckBookRequestQueryInput = z.infer<typeof checkBookRequestQuerySchema>["query"];
export type GetRequestsQueryInput = z.infer<typeof getRequestsQuerySchema>["query"];