...
import { getAdminDashboardData, getUserDashboardData } from "./dashboard.service.js";
...
export const getAdminDashboardController = async (
  ...
  try {
    ...
    sendSuccess(res, "Failed to fetch admin dashboard data", null, undefined, 500);
  }
};
...
export const getUserDashboardController = async (
  ...
  try {
    ...
    sendSuccess(res, "Failed to fetch user dashboard data", null, undefined, 500);
  }
};